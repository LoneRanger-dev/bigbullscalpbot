...
#MarketAnalysis #TradingSetup"""
    ...
    def schedule_signals(self):
        ...
        for timing in intraday_times:
            schedule.every().monday.at(timing).do(self.send_intraday_signal)
            schedule.every().tuesday.at(timing).do(self.send_intraday_signal)
            schedule.every().wednesday.at(timing).do(self.send_intraday_signal)
            schedule.every().thursday.at(timing).do(self.send_intraday_signal)
            schedule.every().friday.at(timing).do(self.send_intraday_signal)
        ...
        print("2. Intraday signals at: 9:15 AM, 10:15 AM, 11:15 AM, 12:15 PM, 1:15 PM, 2:15 PM, 3:15 PM")
